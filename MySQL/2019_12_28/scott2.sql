...
INSERT INTO `dept` VALUES (10,'sales','NEW YORK'),(20,'RESEARCH','DALLAS'),(30,'SALES','CHICAGO'),(40,'OPERATIONS','BOSTON');
...
--
-- Temporary table structure for view `v_ename_dname`
--

DROP TABLE IF EXISTS `v_ename_dname`;
/*!50001 DROP VIEW IF EXISTS `v_ename_dname`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_ename_dname` (
...
--
-- Final view structure for view `v_ename_dname`
--

/*!50001 DROP TABLE IF EXISTS `v_ename_dname`*/;
/*!50001 DROP VIEW IF EXISTS `v_ename_dname`*/;
...
/*!50001 VIEW `v_ename_dname` AS select `emp`.`ename` AS `ename`,`dept`.`dname` AS `dname` from (`emp` join `dept`) where (`emp`.`deptno` = `dept`.`deptno`) */;
...
-- Dump completed on 2019-12-26  8:43:31
